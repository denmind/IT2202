<!DOCTYPE html><?php session_start(); ?><html>
	...
	<body>
		...
		<div class = "main-body">
			<p class = "success">Submission Successful!</p><br>
			<a href = "customers-add-customer.php" class = "new-input">Submit new info</a>
		</div>
	</body>
</html>
	...
	if ($link){
		for($indx = 0 ; $indx < $_SESSION['$re-count'] ; $indx++ ){
			...
			$query = "INSERT INTO client (c_Id, c_FirstName, c_LastName, c_contactInfo) 
					  VALUES (NULL,'".$fname[$indx]."','".$lname[$indx]."','".$cinfo[$indx]."')";
